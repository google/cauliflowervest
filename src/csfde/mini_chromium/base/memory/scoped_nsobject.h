...
#ifndef BPOOP_MINI_CHROMIUM_BASE_MEMORY_SCOPED_NSOBJECT_H_
#define BPOOP_MINI_CHROMIUM_BASE_MEMORY_SCOPED_NSOBJECT_H_
#pragma once
...
#endif  // BPOOP_MINI_CHROMIUM_BASE_MEMORY_SCOPED_NSOBJECT_H_
