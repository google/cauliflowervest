...
#ifndef BPOOP_MINI_CHROMIUM_BASE_MAC_SCOPED_NSAUTORELEASE_POOL_H_
#define BPOOP_MINI_CHROMIUM_BASE_MAC_SCOPED_NSAUTORELEASE_POOL_H_
#pragma once
...
#endif  // BPOOP_MINI_CHROMIUM_BASE_MAC_SCOPED_NSAUTORELEASE_POOL_H_
