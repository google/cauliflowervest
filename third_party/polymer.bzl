...
def polymer_workspace():
  ...
  web_library_external(
      name = "org_polymer_iron_signals",
      licenses = ["notice"],  # BSD-3-Clause
      sha256 = "758503c14a17f2389afa74163e74f095d504f9d54309291ebb42d95112be6768",
      urls = [
          "http://mirror.bazel.build/github.com/PolymerElements/iron-dropdown/archive/v1.5.5.tar.gz",
          "https://github.com/PolymerElements/iron-signals/archive/v1.0.3.tar.gz",
      ],
      strip_prefix = "iron-signals-1.0.3",
      path = "/iron-signals",
      srcs = [
          "iron-signals.html",
      ],
  ...
  web_library_external(
      ...
      licenses = ["notice"],  # BSD-3-Clause
      sha256 = "1d52434edab9416dda6089b56a9370aed8a0bfdaa136301bd609880c07f99b02",
      urls = [
          "https://github.com/PolymerElements/paper-drawer-panel/archive/v1.0.11.tar.gz",
      ],
      strip_prefix = "paper-drawer-panel-1.0.11",
  ...
  web_library_external(
      ...
      licenses = ["notice"],  # BSD-3-Clause
      sha256 = "b8cd3795abc16586d6fb87c0f5c1902d931845cb85a73730c0156eaeef8c6e4f",
      urls = [
          "https://github.com/PolymerElements/iron-a11y-keys/archive/v1.0.9.tar.gz",
      ],
      strip_prefix = "iron-a11y-keys-1.0.9",
      path = "/iron-a11y-keys",
      srcs = [
          "iron-a11y-keys.html",
      ],
  ...
  web_library_external(
      ...
      licenses = ["notice"],  # BSD-3-Clause
      sha256 = "b63bface93b7743e54c3f222f61a4c58424de49720d4acb51a936ff84ac7703d",
      urls = [
          "https://github.com/PolymerElements/iron-localstorage/archive/v1.0.6.tar.gz",
      ],
      strip_prefix = "iron-localstorage-1.0.6",
  ...
  web_library_external(
      ...
      licenses = ["notice"],  # BSD-3-Clause
      sha256 = "51c97a78ec1bbe3f98b3b249a1f48dc679dc6fc031ff02cdda9213bb8c699162",
      urls = [
          "https://github.com/PolymerElements/iron-media-query/archive/v1.0.8.zip",
      ],
  ...
  web_library_external(
      ...
      licenses = ["notice"],  # BSD-3-Clause
      sha256 = "1c4addcb6375770b0ec427a11ce39f31b9ecb92d0bbb053394d81833106d49c7",
      urls = [
          "https://github.com/atotic/lazy-pages/archive/4475e3e7c8de5e233305af0ceb75b3025c18a34a.tar.gz",
      ],
      strip_prefix = "lazy-pages-4475e3e7c8de5e233305af0ceb75b3025c18a34a",
      path = "/lazy-pages",
      srcs = [
          "lazy-pages.html",
      ],
